import { Home, Assignment, MonetizationOn, Group, Warning, Assessment, AccountCircle, Task } from "@mui/icons-material";
...
export const menuItems: SidebarItemType[] = [
  { text: "Dashboard", icon: <Home />, path: "/dashboard", roles: ["admin", "project_manager", "team_member"] },
  ...
  { text: "Tasks", icon : <Task />, path : "/tasks", roles : ["admin","project_manager","team_member"]},
